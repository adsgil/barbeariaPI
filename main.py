...
class RegisterScreen(Screen):  
  ...
  def registro(self, nome, email, senha):
    from functions import create_post
    create_post(self,nome, email, senha)
...
class ForgetSenhaScreen(Screen):
  ...
  def esqueciSenha(self, email, senha):
    from functions import redf_passwd
    redf_passwd(self, email, senha)
...
class ChangeAboutScreen(Screen):
  ...
  def editaInfo(self, nome, email):
    from functions import change_screen
    change_screen(self, nome, email)
...
class CheckinScreen(Screen):
  ...
  def consulta(self, especialidade, data, barbeiro):
    from functions import check
    check(self, especialidade, data, barbeiro)
...
class RegisterBarbeiros(Screen):
  firebase_url =
  auth_key =
  ...
  def registroBarbeiros(self, nome2, email2, senha2):
    from functions import create_post_pacient
    create_post_pacient(self, nome2, email2, senha2)
...
class HourScreen(Screen):
  ...
  def registraPlantao(self, email_funcionario, data2, horario):
    from functions import create_post_hour  
    create_post_hour(self, email_funcionario, data2, horario)
...
screen.add_widget(RegisterBarbeiros(name='cadastrobarbeiros'))
